...
from utils.tensor_utils import (
    unsqueezed_chw_tensor_to_p_by_c,
...
if __name__ == "__main__":
    ...
    for step_num in tqdm(range(brdf_args.training_steps)):
        ...
        spec_c = unsqueezed_chw_tensor_to_p_by_c(model_output["brdf"]["specular_c"]).squeeze(
            1
        )  # (P, )
        ...
        if step_num % brdf_args.image_reporting_interval == 0:
            ...
            if not brdf_args.randomly_sample_loss:
                ...
                starter_image_unrolled = unsqueezed_chw_tensor_to_p_by_c(starter_image)
            ...
            if brdf_args.randomly_sample_loss:
                ...
                full_cam_normals = unsqueezed_chw_tensor_to_p_by_c(
                    model_output["normal"]
                )  # (X, 3)
